...
<html>
    ...
    <body class="web-service-page">
        ...
        <h1>Doc<span class="syllable">vert</span> <span class="version">6</span> <span class="slogan"><abbr title="Microsoft">MS</abbr>Word to Open Standards</span></h1>
...
% for filename, conversion in conversions.items():
